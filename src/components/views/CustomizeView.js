...
export class CustomizeView extends LitElement {
    ...
    getKeybindActions() {
        return [
            ...
            { key: 'pinLeft', name: 'Pin Navigate Left', description: 'Cycle left through pinned design/code chips' },
            { key: 'pinRight', name: 'Pin Navigate Right', description: 'Cycle right through pinned design/code chips' },
